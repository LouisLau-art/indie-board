...
- **Styling**: [UnoCSS 66.x](https://unocss.dev) + [Onu UI 1.1.5](https://github.com/onu-ui/onu-ui)
...
│   │   └── index.vue        # 主页
│   └── components/
│       ├── ProductCard.vue  # 产品卡片 (Onu UI)
│       ├── SubmitForm.vue   # 提交表单 (Onu UI)
...
├── uno.config.ts            # UnoCSS + Onu UI 配置
